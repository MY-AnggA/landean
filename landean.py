...
# landean-enc
# Author  : Angga Alfarizi
# Github  : https://github.com/MY-AnggA
# Contact : https://t.me/anggaalfarizi
# Language: Python(3)
# Date    : 18-08-2050
...
def about():
    os.system("clear")
    sprint(logo, 0.01)
    print(f"{cyan}[ToolName]  {purple} :[landean-enc]")
    print(f"{cyan}[Version]   {purple} :[1.0]")
    print(f"{cyan}[Author]    {purple} :[Angga Alfarizi]")
    print(f"{cyan}[Github]    {purple} :[https://github.com/MY-AnggA]")
    print(f"{cyan}[Messenger] {purple} :[https://t.me/anggaalfarizi]")
    print(f"{cyan}[Email]     {purple} :[email.anggaalfarizi.tips]\n")
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        ...
        out_f.write("# Encrypted by Angga Alfarizi\n# Github- https://github.com/MY-AnggA/landean-enc\n\n"+filedata)
    os.remove(".temp")
...
def decryptsh():
    ...
    with open(".temp2",'r') as temp_f2, open(out_file,'w') as out_f:
        ...
        out_f.write("# Decrypted by Angga Alfarizi\n# Github- https://github.com/MY-AnggA/landean-enc\n\n"+filedata)
    os.remove(".temp2")
    sprint(f"{success}{out_file} saved in {pwd}")
    mover(out_file)
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system("xdg-open --view 'https://github.com/MY-AnggA#My-Best-Works'")
            else:
                os.system("xdg-open 'https://github.com/MY-AnggA#My-Best-Works'")
            main()
